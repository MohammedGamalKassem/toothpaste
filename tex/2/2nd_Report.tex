...
\begin{figure}[htbp]
    \centering
    \img[width=0.6\textwidth]{cylinderical.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{S-band transceiver (TT\&C).}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \img[width=\linewidth]{S2-Band-FM-01.png}
        \caption{S-band RF front-end module.}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{X-band downlink transmitter (payload data).}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \img[width=\linewidth]{XbandAntenna.png}
        \caption{X-band antenna (high-rate downlink).}
    \end{subfigure}

    \caption{Representative Communication Subsystem components for S-band TT\&C and X-band payload downlink.}
    \label{fig:comms_components}
\end{figure}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|p{2.4cm}|p{2.6cm}|p{3.4cm}|p{1.9cm}|p{2.3cm}|p{2.8cm}|}
        \hline
...
\begin{figure}[htbp]
    \centering
    \img[width=0.7\textwidth]{Water.png}
...
\begin{figure}[htbp]
    \centering
    \img[width=0.7\textwidth]{urban planning.png}
...
\begin{figure}[htbp]
    \centering
    \img[width=0.7\textwidth]{coastal erosion and marine traffic.png}
