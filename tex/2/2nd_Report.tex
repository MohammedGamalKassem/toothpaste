...
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{}C{0.05\linewidth}L{0.3\linewidth}L{0.16\linewidth}L{0.42\linewidth}C{0.06\linewidth}@{}}
\toprule
\textbf{\#} & \textbf{Name / ID} & \textbf{} & \textbf{Assigned tasks (this report)} & \\
\midrule
1 & \textit{Mohammed Gamal Kassem} &  & Desertification(User Requirements), Mass and Power budget, and Organization of the whole report & \\
2 & \textit{Ahmed Raafat Salah} &  & Development of idea, Mission Statement, Team Formation, and  Dams and Major Structure(User Requirements)& \\
3 & \textit{Basmala Hatem Mohamed} &  & Monitoring forest fires(User Requirements), Communication Subsystem (A)(Familiarization), and Ground Station  &\\
4 & \textit{Mariam Amr Mohamed} &  & Maritime Monitoring(User Requirements), Imager Subsystem(Familiarization) &\\
5 & \textit{Rania Hany Haider} & & Urban Planning(User Requirements), ADCS Subsystem(Familiarization), and Satellite Operation and User Request Implementation & \\
6 & \textit{Reem Osama Ahmed} &  & Drought(User Requirements), Structure Subsystem(Familiarization), and Orbit Analysis & \\
7 & \textit{Shrouk Goama Abdelhamed} &  & Water Resource Monitoring(User Requirements), Communication Subsystem (B)(Familiarization), and Critical Technologies  & \\
8 & \textit{Rawan Mahmoud Sami} & & Agriculture(User Requirements), Power Subsystem(Familiarization), and Time Plan, and Launch &\\
\bottomrule
\end{longtable}
\newpage
...
\begin{figure}[htbp!]
    \centering
    \img[width=0.6\textwidth]{Push.jpg}
    \caption{Conceptual representation of a push-broom imager package (cylindrical optical housing).}
    \label{fig:imager_package}
\end{figure}
\newpage
...
\begin{figure}[htbp!]
    \centering
    \img[width=0.5\textwidth]{Dam.png}
    \caption{Example of very high-resolution imaging for Dams }
    \label{fig:req_dam}
\end{figure}
