...
\hypersetup{
    ...
    urlcolor=SatGold,
    hypertexnames=false,
    pdftitle={AER 3510 --- Report 1: Development of Idea & Mission Analysis},
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{1st_Report/RemoteSensing Mission.png}
    \caption{Concept of Operations for the Remote Sensing Mission.}
    \label{fig:conops}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{1st_Report/FlatSatModel.jpg}
    \caption{Proposed FlatSat integration layout for subsystem verification.}
    \label{fig:flatsat}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{1st_Report/Budget.png}
    \caption{Estimated cost distribution.}
    \label{fig:cost_dist}
\end{figure}
...
\begin{figure}[H!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{example-image-structure.png}}
    \caption{Typical small satellite structural chassis.}
    \label{fig:sub_structure}
\end{figure}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/EPS_NanoPower-P60-Featured-1.png}
        \caption{EPS}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/main_NanoPower-BPX-Featured-Image.png}
        \caption{Main Battery}
        \label{fig:sub2}
    \end{subfigure}
    
    \vspace{0.4cm}   % vertical space between rows (adjust as needed)
    
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/primary_lithium_battery_3_6v_14500mah_cylindrical_lithium_battery_cell.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/solar_panels.jpg}
        \caption{Solar Panel}
        \label{fig:sub4}
    \end{subfigure}
    
    \caption{Overall components for the Power Subsystem}
    \label{fig:fourpics}
\end{figure}
\newpage
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/hor.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/magnet.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/a7a.png}
        \caption{Star Sensor}
        \label{fig:sub3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/sun.png}
        \caption{Sun sensor}
        \label{fig:sub4}
    \end{subfigure}
    \vspace{0.4cm}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/mag tourq.png}
        \caption{Magnetic Tourq}
        \label{fig:sub4}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/motor.png}
        \caption{Reaction Wheel}
        \label{fig:sub4}
    \end{subfigure}
    \caption{Overall components for the ADCS Subsystem}
    \label{fig:fourpics}
\end{figure}
\newpage
...
\begin{figure}[H!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{example-image-imager.png}}
    \caption{Push-broom Imager Subsystem and focal plane electronics.}
    \label{fig:sub_imager}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/High-speed X-band Downlink Transmitter.png}
        \caption{X-band}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/S2-Band-FM-01.png}
        \caption{S-band}
        \label{fig:sub2}
    \end{subfigure}
    \caption{Communication Subsystem components: S-band transceiver (left) and X-band patch antenna with Image Storage Unit (right).}
    \label{fig:sub_comms}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Project Lead / Academic Authority:} The System Engineer operates under the direct supervision of \textbf{Prof. Mohammed Argoun (Father of Sapce in Egypt)}, who serves as the ultimate technical authority and project director. 
\end{itemize}
...
\begin{table}[h]
    ...
    \begin{tabular}{|p{3cm}|p{3cm}|p{4cm}|p{2cm}|p{2.5cm}|p{3cm}|}
        \hline
        ...
        Phase 8: Launch \& Commissioning & Deploy and activate satellite & Orbit insertion, subsystem checkout, first images & Month 16 & Operations team & Commissioned satellite \\ \hline
    \end{tabular}
\end{table}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{ganntchart.jpeg}
    \caption{Project time plan and Gantt Chart.}
    \label{fig:gantt}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{2nd_Report images/67d97b0c3cfb1b304f84f756_Strawberries20and20lettuce.png}
    \caption{Example of multispectral NDVI imaging for crop monitoring.}
    \label{fig:req_agri}
\end{figure}
\begin{itemize}
...
\begin{figure}[H!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{example-image-water.png}}
    \caption{Example of optical satellite tracking for surface water and pollution.}
    \label{fig:req_water}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{2nd_Report images/Dam.png}
    \caption{Example of high-resolution structural observation of a dam.}
    \label{fig:req_dams}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{2nd_Report images/utban.png}
    \caption{Example of very high-resolution panchromatic imaging for urban mapping.}
    \label{fig:req_urban}
\end{figure}
\begin{itemize}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/sa7ra/Gemini_Generated_Image_jx12dyjx12dyjx12 (3).png}
        \caption{}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/sa7ra/Gemini_Generated_Image_jx12dyjx12dyjx12 (2).png}
        \caption{}
        \label{fig:sub2}
    \end{subfigure}
    
    \vspace{0.2cm}   % vertical space between rows (adjust as needed)
    
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/sa7ra/Gemini_Generated_Image_jx12dyjx12dyjx12 (1).png}
        \caption{}
        \label{fig:sub3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{2nd_Report images/sa7ra/Gemini_Generated_Image_jx12dyjx12dyjx12.png}
        \caption{}
        \label{fig:sub4}
    \end{subfigure}
    
    \caption{Example of wide-swath imaging to track desertification boundaries.}
    \label{fig:fourpics}
\end{figure}
...
\begin{figure}[H!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{example-image-disaster.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{2nd_Report images/fire.png}
    \caption{Example of thermal infrared sensing to identify active fire hotspots.}
    \label{fig:req_fire}
\end{figure}
\begin{itemize}
...
\begin{figure}[H!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{example-image-coastal.png}}
    \caption{Example of multispectral imaging tracking coastal erosion and maritime traffic.}
